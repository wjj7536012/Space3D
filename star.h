...
private:
	void motion()
	{
        double lx1,ly1,lx2,ly2,angle1,angle2,d1,d2;
		float g1,g2,gx1,gx2,gy1,gy2,vtx,vty,vt,dt,dx,dy;
		int ang1,ang2,i;
		...
		g1=o_star1->mass*mass/(d1*d1);
		g2=o_star2->mass*mass/(d2*d2);
